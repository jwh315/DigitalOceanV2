...
use DigitalOceanV2\Entity\ForwardRule as ForwardRuleEntity;
...
class LoadBalancer extends AbstractApi
{
    ...
    {
        $data = is_object($loadBalancerSpec) ? $loadBalancerSpec->toApiArray() : $loadBalancerSpec;
    ...
    private function formatForwardRules($forwardRules)
    {
        return array_map(function ($rule) {
            return (is_array($rule)) ? $rule : $rule->toApiArray();
        }, $forwardRules);
    }
}
